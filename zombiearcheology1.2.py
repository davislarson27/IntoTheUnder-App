...
def user_data_dir(app_name="ZombieArcheology"):
...
# directory = "game_files/my_first_world"
# image_file_load_directory = resource_path("game_files/my_first_world")

save_path = user_data_dir()
directory = os.path.join(save_path, "my_first_world")
...
while running and menu.menu_running:
    ...
    if menu.run_game:
        ...
        if not inventory.show_full_inventory: # right now if this is active, it stops the whole game
            ...
            # print(f"collided: {collided}, vel = {player.y_vel}")
